    ...
    switch (event.type) {
        ...
        case 'event_delta': {
            ...
            if (idx > accumulated.content.length) {
                throw new AnthropicError(`event_delta index ${idx} is beyond the end of content (length ${accumulated.content.length})`);
            }
...
//# sourceMappingURL=accumulate.mjs.map