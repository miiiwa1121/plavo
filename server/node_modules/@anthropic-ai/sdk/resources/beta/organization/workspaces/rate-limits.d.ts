...
export declare class RateLimits extends APIResource {
     ...
     * ```
     */
    list(workspaceID: string, query?: RateLimitListParams | null | undefined, options?: RequestOptions): PagePromise<BetaWorkspaceRateLimitsPageCursor, BetaWorkspaceRateLimit>;
}
...
export declare namespace RateLimits {
    export { type BetaWorkspaceRateLimit as BetaWorkspaceRateLimit, type BetaWorkspaceRateLimitValue as BetaWorkspaceRateLimitValue, type BetaWorkspaceRateLimitsPageCursor as BetaWorkspaceRateLimitsPageCursor, type RateLimitListParams as RateLimitListParams, };
}
